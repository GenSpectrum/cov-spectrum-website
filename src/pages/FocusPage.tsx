...
import { DateRange, isRegion, SamplingStrategy, toLiteralSamplingStrategy , getWikiExtract} from '../services/api';
...
export const FocusPage = ({
  ...
  return (
    <>
      ...
      <Button onClick={() => {variant.name && getWikiExtract(`Lineage_${variant.name}`)}}>Wiki</Button>
      {variant.name && (
        <VariantMutations
