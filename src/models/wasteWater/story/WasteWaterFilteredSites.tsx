import { filterByDateRange, getMaxDateRange, useWasteWaterData, WasteWaterDataWithLocation } from './WasteWaterSamplingSitesHooks';
...
export const WasteWaterFilteredSites = (filterFunction = (x: WasteWaterDataWithLocation):Boolean => true) => {
  ...
  const dataInTimeRange = filterByDateRange(wasteWaterData, dateRangeSelector.getDateRange()).filter(filterFunction);
