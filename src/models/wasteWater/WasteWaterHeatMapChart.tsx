    ...
    <Wrapper>
      ...
      <ChartAndMetricsWrapper2>
        <div id='heatmap-inner-wrapper' className='flex mr-10 w-full overflow-x-scroll md:overflow-x-hidden'>
          <div style={{ width: '120px', height: '100%', display: 'block' }} className='md:overflow-x-scroll'>
            <table style={{ tableLayout: 'fixed', width: '110px', height: '100%' }}>
              <tbody>{nucMutationsLabelTableRows}</tbody>
            </table>
          </div>
          <div
            className='md:overflow-x-scroll'
            style={{ width: 'calc(100% - 120px)', height: '100%', display: 'block' }}
          >
