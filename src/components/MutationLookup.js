...
export class MutationLookup extends React.Component {
  constructor(props) {
    ...
    this.handleMatchPercentageFieldChange = this.handleMatchPercentageFieldChange.bind(
      this
    );
          ...
          <Form>
            ...
            <Form.Group controlId="matchPercentageGroup">
              ...
              <span style={{ marginLeft: "30px" }}>
                {this.state.selectedMatchPercentage}%
              </span>
              <Form.Control
                type="range"
            ...
            <Button variant="primary" onClick={this.handleSearchButtonClick}>
              Search
            </Button>
          </Form>
        )}
